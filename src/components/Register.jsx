        ...
        <>
            <Box display={'flex'} alignItems={'Center'} justifyContent={'Center'} bgColor={'purple.100'} minH={['90vh', '85vh']} >
                <VStack w={['80vw', '25vmax']} h={['50vmax', '30vmax']} bg={'white'} borderRadius={'1%'}>
                    ...
                    <FormControl >
                        <HStack><Box opacity={'0.5'} pt={'8%'} pos={"absolute"}  transform={'auto'} translateX={['9.5vw', '3.5vw']}><HiOutlineUserCircle size={'30'} /></Box><Input id="a" placeholder='Name' type='text' borderColor={'purple.300'} borderWidth={'1px'} onChange={(e) => setName(e.target.value)} pl={'15%'} ml={'10%'} mr={'10%'} h={['5vmax', '3vmax']} mt={'8%'} focusBorderColor='purple.300' ></Input></HStack>
                        <HStack><Box opacity={'0.5'} pt={'8%'} pos={"absolute"}  transform={'auto'} translateX={['9.5vw', '3.5vw']}><HiOutlineMail size={'30'} /></Box><Input id="b" placeholder='Email' type='email' borderColor={'purple.300'} onChange={(e) => setLoginEmail(e.target.value)} borderWidth={'1px'} pl={'15%'} ml={'10%'} mr={'10%'} h={['5vmax', '3vmax']} mt={'8%'} focusBorderColor='purple.300' ></Input></HStack>
                        <HStack><Box opacity={'0.5'} pt={'8%'} pos={"absolute"}  transform={'auto'} translateX={['9.5vw', '3.5vw']}><GoLock size={'30'} /></Box><Input id="c" placeholder='Password' type='password' borderColor={'purple.300'} onChange={(e) => setLoginPassword(e.target.value)} borderWidth={'1px'} pl={'15%'} ml={'10%'} mr={'10%'} h={['5vmax', '3vmax']} mt={'8%'} focusBorderColor='purple.300' ></Input></HStack>
